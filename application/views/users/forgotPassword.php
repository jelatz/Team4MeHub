...
<head>
	...
	<title>Team4MeHub Forgot Password</title>
</head>
...
<body class="bg-secondary-subtle">
	<div class="container-fluid bg-secondary-subtle mt-5">
        ...
        <h5 class="my-2">Password Reset</h5>
			<form action="<?php echo base_url(); ?>loginMe" method="post">
				...
				<div class="">
					<input type="submit" class="btn btn-primary d-block mx-auto w-50" value="Submit" />
					<a href="<?php echo base_url() ?>login" class="link-offset-2 link-underline link-underline-opacity-0 d-block text-start">Login</a><br>
				</div>
			</form>
		</div>
		</div>
