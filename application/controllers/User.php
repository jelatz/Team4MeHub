...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'Team4MeHub : Dashboard';
        $this->loadViews("includes/header", $this->global, NULL, NULL);
        $this->loadViews("general/sideNav", $this->global, NULL, NULL);
        $this->loadViews("general/dashboard", $this->global, NULL, NULL);
        $this->loadViews("includes/footer", $this->global, NULL, NULL);
    }
    ...
    function userListing()
    {
        if (!$this->isAdmin()) {
            ...
            $this->global['pageTitle'] = 'Team4MeHub : User Listing';
    ...
    function addNew()
    {
        if (!$this->isAdmin()) {
            ...
            $this->global['pageTitle'] = 'Team4MeHub : Add New User';
    ...
    function editOld($userId = NULL)
    {
        if (!$this->isAdmin()) {
            ...
            $this->global['pageTitle'] = 'Team4MeHub : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'Team4MeHub : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        if (!$this->isAdmin()) {
            ...
            $this->global['pageTitle'] = 'Team4MeHub : User Login History';
